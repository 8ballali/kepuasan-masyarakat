    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="#" class="nav-link active">Add Question</a>
                </li>
            </ul>
            ...
            <div class="sidebar">
               ...
               <li class="nav-item menu-open">
                ...
                <ul class="nav nav-treeview">
                    ...
                    <li class="nav-item">
                        <a href="/penilaian/admin/answer/add" class="nav-link active">
                            <i class="far fa-circle nav-icon"></i>
                            <p>Add Answer</p>
                        </a>
                    </li>
                ...
                <div class="container">
                    <div class="card mt-5">
                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="/penilaian/admin/answer/store" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="bgcolor" class="form-control" placeholder="Background"></textarea>
