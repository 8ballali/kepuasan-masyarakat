    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="/penilaian/admin" class="nav-link active">Answer</a>
                </li>
            </ul>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Data Answer</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
            ...
            <section class="content">
                ...
                <div class="card">
                    <div class="card-heade\r">
                        <h3 class="card-title">Data Answer</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $a->id }}</td>
                                    <td>{{ $a->answer }}</td>
                                    <td><img src="{{ url('data_file').'/'.$a->file }}" height="30px" width="30px" /></td>
                                    <td>{{ $a->bgcolor }}</td>
                                    <td>{{ $a->updated_at }}</td>
                                    <td>
                                        <a href="/penilaian/admin/answer/delete/{{ $a->id }}"
                                            onClick="confirm('Delete entry?')" class="btn btn-danger btn-sm">Hapus</a>
                                        <a href="/penilaian/admin/answer/edit/{{ $a->id }}"
